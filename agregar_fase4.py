"""
Script para agregar los 32 partidos de la Fase 4 (Eliminación Directa)
...
def agregar_fase4():
    """Agrega los 32 partidos de la Fase 4 (Eliminación Directa)"""
    with app.app_context():
        ...
        if partidos_fase4_existentes > 0:
            print(f"⚠️  Ya existen {partidos_fase4_existentes} partidos de Fase 4")
            respuesta = input("¿Deseas continuar y agregar los partidos faltantes? (s/n): ")
